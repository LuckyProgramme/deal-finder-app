...
class SyncJobRows extends Table with TableInfo<SyncJobRows, SyncJobRowsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SyncJobRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  SyncJobRowsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return SyncJobRowsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  SyncJobRows createAlias(String alias) {
    return SyncJobRows(attachedDatabase, alias);
  }
...
class SyncJobRowsData extends DataClass implements Insertable<SyncJobRowsData> {
  final String id;
  final String payload;
  const SyncJobRowsData({required this.id, required this.payload});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<String>(id);
  ...
  factory SyncJobRowsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  SyncJobRowsData copyWith({String? id, String? payload}) =>
      SyncJobRowsData(id: id ?? this.id, payload: payload ?? this.payload);
  @override
  String toString() {
    return (StringBuffer('SyncJobRowsData(')
          ..write('id: $id, ')
          ..write('payload: $payload')
          ..write(')'))
        .toString();
...
class DatabaseAtV4 extends GeneratedDatabase {
  ...
  late final SyncJobRows syncJobRows = SyncJobRows(this);
  @override
